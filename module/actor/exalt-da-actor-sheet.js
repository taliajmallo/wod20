...
export class ExaltDarkAgesActorSheet extends MortalActorSheet {
  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["vtm5e", "sheet", "actor", "exalt-da"],
      template: "systems/evwod/templates/actor/exalt-da-sheet.html",
      width: 800,
      height: 700,
      tabs: [
        {
  ...
  get template() {
    ...
    return "systems/evwod/templates/actor/exalt-da-sheet.html";
  }
  ...
  getData() {
    ...
    data.sheetType = `${game.i18n.localize("VTM5E.ExaltDarkAges")}`;

    // Prepare items.
    if (this.actor.data.type === "exalt-da") {
